...
const preserved = [
  'tab-deals', 'tab-gems', 'tab-scout', 'btn-fullscan', 'btn-scan-cancel', 'btn-settings', 'btn-telegram',
...
assert.ok(/id="tab-deals"/.test(html) && /id="tab-gems"/.test(html) && /id="tab-scout"/.test(html), 'Deals, Rare gems and Scout remain primary tabs');
